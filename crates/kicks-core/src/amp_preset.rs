...
impl AmpPreset {
    ...
    pub fn new(
        name: &str, description: &str, tags: Vec<&str>, gain: f32, master: f32, bass: f32,
        mid: f32, treble: f32, drive: f32,
    ) -> Self {
        Self {
            name: name.to_string(),
...
fn classic_rock_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Whole Lotta",
            "Jimmy Page's Plexi. Vocal mids, slightly overdriven, that famous percussive attack.",
            vec!["classic-rock", "led-zeppelin", "page", "marshall", "plexi"],
            0.55,
            0.55,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "AC/DC Crunch",
            "Angus Young's cranked Plexi. Raw, mid-forward, no low-end flab. Pure rock.",
            vec!["classic-rock", "acdc", "angus", "marshall"],
            0.60,
            0.55,
            0.40,
            0.65,
        ...
        AmpPreset::new(
            "Aerosmith Lead",
            "Joe Perry's hot-rodded Marshall. Smooth singing lead with just enough hair.",
            vec!["classic-rock", "aerosmith", "perry", "lead"],
            0.60,
            0.55,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "ZZ Top Crunch",
            "Billy Gibbons' Pearly Gates. Fat, mid-pushed, with a touch of grind.",
            vec!["classic-rock", "zz-top", "gibbons", "fat"],
            0.50,
            0.55,
            0.60,
            0.65,
        ...
        AmpPreset::new(
            "Brown Sugar",
            "Keith Richards' JTM45 pushed. Open, airy, mid-rich. The riff master.",
            vec!["classic-rock", "rolling-stones", "richards", "jtm45"],
            0.50,
            0.60,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "Won't Get Fooled",
            "Pete Townshend's Hiwatt stack. Punchy, articulate windmill power chord crunch.",
            vec![
                "classic-rock",
                "the-who",
                "townshend",
        ...
        AmpPreset::new(
            "You Really Got Me",
            "Dave Davies' cranked ElPico. The original distorted rock tone. Razor-edged.",
            vec!["classic-rock", "kinks", "davies", "vintage-distortion"],
            0.60,
            0.50,
            0.40,
            0.55,
        ...
        AmpPreset::new(
            "Proud Mary",
            "John Fogerty's Bassman clean-to-crunch. Swampy, mid-forward, unmistakable.",
            vec!["classic-rock", "creedence", "fogerty", "bassman"],
            0.45,
            0.60,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "American Girl",
            "Tom Petty's Vox AC30 chime. Jangling, bright, relentlessly optimistic.",
            vec!["classic-rock", "tom-petty", "vox", "jangle"],
            0.35,
            0.65,
            0.40,
            0.55,
        ...
        AmpPreset::new(
            "Ace of Spades",
            "Lemmy's Marshall full-stack grind. Mid-heavy, aggressive, zero bass flab.",
            vec![
                "classic-rock",
                "motorhead",
                "lemmy",
        ...
        AmpPreset::new(
            "Highway Star",
            "Ritchie Blackmore's Marshall lead. Cutting, aggressive, classically-tinged.",
            vec!["classic-rock", "deep-purple", "blackmore", "lead"],
            0.55,
            0.55,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Rebel Rebel",
            "David Bowie's Mick Ronson tone. Marshally, crystalline, larger than life.",
            vec!["classic-rock", "bowie", "ronson", "glam-rock"],
            0.50,
            0.60,
            0.50,
            0.50,
        ...
        AmpPreset::new(
            "Free Bird",
            "Gary Rossington's Plexi lead. Singing, sustained, deeply Southern rock.",
            vec![
                "classic-rock",
                "lynyrd-skynyrd",
                "rossington",
        ...
        AmpPreset::new(
            "Heartbreaker",
            "Page's Plexi on the verge of chaos. Aggressive, biting, about-to-explode sound.",
            vec!["classic-rock", "led-zeppelin", "page", "aggressive"],
            0.60,
            0.50,
            0.50,
            0.55,
...
fn modern_metal_prog_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Djent",
            "Tight, percussive low-end. Polyrhythm-ready with controlled gain and massive attack.",
            vec!["high-gain", "djent", "tight", "percussive", "prog"],
            0.75,
            0.45,
            0.65,
            0.25,
        ...
        AmpPreset::new(
            "Periphery",
            "Modern high-gain with tight bass and cutting mids. The Periphery rhythm sound.",
            vec!["high-gain", "periphery", "modern", "tight", "rhythm"],
            0.80,
            0.40,
            0.60,
            0.30,
        ...
        AmpPreset::new(
            "Meshuggah",
            "The ultimate chug. Fortin-designed, impossibly tight, mathematically precise.",
            vec!["high-gain", "meshuggah", "fortin", "chug", "mathematical"],
            0.90,
            0.35,
            0.65,
            0.20,
        ...
        AmpPreset::new(
            "Tesseract",
            "Ambient, precise modern metal. Tight distortion with room to breathe.",
            vec!["high-gain", "tesseract", "modern", "ambient", "djent"],
            0.80,
            0.45,
            0.60,
            0.30,
        ...
        AmpPreset::new(
            "Monuments",
            "Groove-oriented modern metal. Percussive, syncopated, massive.",
            vec!["high-gain", "monuments", "djent", "groove"],
            0.80,
            0.40,
            0.60,
            0.25,
        ...
        AmpPreset::new(
            "Animals as Leaders",
            "Progressive, clean, precise. Orchestral metal with extreme clarity.",
            vec!["high-gain", "animals-as-leaders", "prog", "precise"],
            0.75,
            0.45,
            0.55,
            0.30,
        ...
        AmpPreset::new(
            "Architects",
            "Modern UK metalcore. Big lows, sampled precision, massive walls of sound.",
            vec!["high-gain", "architects", "metalcore", "modern", "uk"],
            0.85,
            0.40,
            0.65,
            0.20,
        ...
        AmpPreset::new(
            "Northlane",
            "Atmospheric modern metal with crushing lows and ambient mids.",
            vec!["high-gain", "northlane", "atmospheric", "modern"],
            0.80,
            0.45,
            0.65,
            0.25,
        ...
        AmpPreset::new(
            "Parkway Drive",
            "Australian metalcore. Bold, aggressive, rhythm-focused.",
            vec!["high-gain", "parkway-drive", "metalcore", "aggressive"],
            0.85,
            0.40,
            0.60,
            0.25,
        ...
        AmpPreset::new(
            "Killswitch Engage",
            "Melodic metalcore. Harmonious brutality. Big gain with singing mids.",
            vec!["high-gain", "killswitch-engage", "metalcore", "melodic"],
            0.80,
            0.45,
            0.60,
            0.30,
        ...
        AmpPreset::new(
            "Trivium",
            "Modern thrash-infused metal. Aggressive, technical, cutting.",
            vec!["high-gain", "trivium", "thrash", "modern", "technical"],
            0.80,
            0.40,
            0.55,
            0.25,
        ...
        AmpPreset::new(
            "Gojira",
            "Unique French metal. Crushing, rhythmic, signature low-end thump.",
            vec!["high-gain", "gojira", "french", "rhythmic", "unique"],
            0.85,
            0.40,
            0.70,
            0.20,
        ...
        AmpPreset::new(
            "Lamb of God",
            "American groove metal. Aggressive, percussive, wall-of-sound rhythm.",
            vec!["high-gain", "lamb-of-god", "groove-metal", "american"],
            0.80,
            0.45,
            0.60,
            0.25,
        ...
        AmpPreset::new(
            "Opeth",
            "Progressive Swedish metal. From clean to crushing, dynamic range for days.",
            vec!["high-gain", "opeth", "prog", "swedish", "dynamic"],
            0.75,
            0.50,
            0.55,
            0.35,
        ...
        AmpPreset::new(
            "Mastodon",
            "Sludgey, progressive, massive. Thick low-end with psychedelic mids.",
            vec!["high-gain", "mastodon", "sludge", "prog", "thick"],
            0.80,
            0.45,
            0.65,
            0.30,
        ...
        AmpPreset::new(
            "Tool",
            "Adam Jones' Diezel/Darkglass hybrid. Big, dark, atmospheric. Tension personified.",
            vec!["high-gain", "tool", "adam-jones", "diezel", "dark"],
            0.70,
            0.50,
            0.60,
            0.35,
        ...
        AmpPreset::new(
            "Deftones",
            "Stephen Carpenter's 5150 wall. Shoegaze meets metal. Thick, ethereal, punishing.",
            vec!["high-gain", "deftones", "shoegaze-metal", "atmospheric"],
            0.80,
            0.45,
            0.65,
            0.30,
...
fn jazz_fusion_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Wes Montgomery",
            "Thumb-picked warmth through a Fender Twin. Round, octave-heavy, deeply soulful.",
            vec!["jazz", "wes-montgomery", "fender", "warm", "thumb"],
            0.20,
            0.70,
            0.55,
            0.65,
        ...
        AmpPreset::new(
            "George Benson",
            "GB's hot-rodded clean. Punchy, articulate, brilliant single-note attack.",
            vec!["jazz", "george-benson", "boutique", "punchy"],
            0.30,
            0.70,
            0.50,
            0.65,
        ...
        AmpPreset::new(
            "Pat Metheny",
            "Pat's ultra-clean Roland JC. Chorusy, lush, pitch-perfect clarity.",
            vec!["jazz", "pat-metheny", "roland", "clean", "lush"],
            0.15,
            0.75,
            0.50,
            0.50,
        ...
        AmpPreset::new(
            "John Scofield",
            "Sco's gritty, mid-heavy tone. Dirty but sophisticated. Jazz with a snarl.",
            vec!["jazz", "john-scofield", "gritty", "mid-heavy"],
            0.45,
            0.60,
            0.50,
            0.70,
        ...
        AmpPreset::new(
            "Allan Holdsworth",
            "Ultra-clean, horn-like legato. Peak clarity, zero distortion. The master's canvas.",
            vec!["jazz", "fusion", "holdsworth", "legato", "clean"],
            0.15,
            0.80,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Frank Gambale",
            "Super-clean sweep-picking tone. Output for days, clarity forever.",
            vec!["jazz", "fusion", "gambale", "sweep", "crystal"],
            0.20,
            0.75,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Greg Howe",
            "Searing high-gain shred meets soulful phrasing. Technique with feel.",
            vec!["jazz", "fusion", "greg-howe", "shred", "high-gain"],
            0.65,
            0.55,
            0.50,
            0.40,
        ...
        AmpPreset::new(
            "Guthrie Govan",
            "The modern master. Ultra-versatile — clean to mean, always musical.",
            vec!["jazz", "fusion", "guthrie-govan", "versatile"],
            0.35,
            0.65,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Andy Timmons",
            "Singing lead tone. Warm, expressive, gorgeous mid-range push.",
            vec!["jazz", "fusion", "andy-timmons", "singing", "lead"],
            0.55,
            0.55,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "Eric Johnson",
            "EJ's meticulous, chiming clean. Layers upon layers of perfect tone.",
            vec!["jazz", "fusion", "eric-johnson", "chiming", "meticulous"],
            0.30,
            0.70,
            0.50,
            0.60,
        ...
        AmpPreset::new(
            "Mike Stern",
            "High-octane jazz. Overdriven, aggressive, horn-like phrasing.",
            vec!["jazz", "mike-stern", "overdriven", "aggressive"],
            0.50,
            0.55,
            0.50,
            0.60,
        ...
        AmpPreset::new(
            "Lee Ritenour",
            "Polished jazz clean. Smooth, professional, refined.",
            vec!["jazz", "lee-ritenour", "clean", "polished"],
            0.25,
            0.70,
            0.50,
            0.60,
...
fn country_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Nashville Clean",
            "Tele into a Fender Twin. Bright, twangy, chicken-pickin' snap.",
            vec!["country", "nashville", "telecaster", "twin", "twang"],
            0.15,
            0.80,
            0.40,
            0.50,
        ...
        AmpPreset::new(
            "Brad Paisley",
            "Brad's cranked Fender DRRI. Twang with a bite. Modern country lead.",
            vec!["country", "brad-paisley", "fender", "twang", "lead"],
            0.40,
            0.65,
            0.40,
            0.55,
        ...
        AmpPreset::new(
            "Brent Mason",
            "Nashville session legend. Ultra-clean, dynamic, perfect Tele snap.",
            vec![
                "country",
                "brent-mason",
                "session",
        ...
        AmpPreset::new(
            "Johnny Hiland",
            "Blazing Tele through a clean Fender. Twang at warp speed.",
            vec!["country", "johnny-hiland", "telecaster", "fast", "twang"],
            0.25,
            0.70,
            0.40,
            0.50,
        ...
        AmpPreset::new(
            "Vince Gill",
            "Singing, soulful country lead. Warm mids, clear top, tons of feel.",
            vec!["country", "vince-gill", "lead", "singing"],
            0.30,
            0.70,
            0.50,
            0.60,
        ...
        AmpPreset::new(
            "Albert Lee",
            "Country legend. Bright, fast, impeccably clean with a cutting edge.",
            vec!["country", "albert-lee", "fast", "bright"],
            0.25,
            0.70,
            0.40,
            0.55,
        ...
        AmpPreset::new(
            "James Burton",
            "Elvis's Tele man. Pioneering country-rock bite.",
            vec!["country", "james-burton", "telecaster", "vintage"],
            0.30,
            0.65,
            0.40,
            0.55,
        ...
        AmpPreset::new(
            "Don Rich",
            "Buck Owens' right hand. Pure Bakersfield twang. Bright, cutting, classic.",
            vec!["country", "don-rich", "bakersfield", "twang"],
            0.25,
            0.65,
            0.35,
            0.50,
        ...
        AmpPreset::new(
            "Chet Atkins",
            "Mr. Guitar. Warm, finger-picked perfection through a clean Fender.",
            vec!["country", "chet-atkins", "fingerstyle", "warm"],
            0.20,
            0.70,
            0.50,
            0.60,
        ...
        AmpPreset::new(
            "Tele Twang",
            "Pure Tele bridge into a clean Fender. Country in a box.",
            vec!["country", "telecaster", "twang", "bridge"],
            0.15,
            0.75,
            0.35,
            0.50,
        ...
        AmpPreset::new(
            "Outlaw Country",
            "Waylon's cranked Fender/Marshall mix. Darker, bigger, outlaw attitude.",
            vec!["country", "outlaw", "waylon", "dark"],
            0.40,
            0.60,
            0.60,
            0.55,
...
fn funk_rnb_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Nile Rodgers",
            "That Strat into a clean Roland. The most sampled guitar tone in history. Funky.",
            vec!["funk", "nile-rodgers", "roland", "strat", "iconic"],
            0.10,
            0.80,
            0.40,
            0.50,
        ...
        AmpPreset::new(
            "Cory Wong",
            "Ultra-tight, compressed funk rhythm. Clean, percussive, impossibly tight.",
            vec!["funk", "cory-wong", "tight", "compressed"],
            0.12,
            0.80,
            0.45,
            0.55,
        ...
        AmpPreset::new(
            "Prince",
            "Purple majesty. Crisp, funky, larger than life. Hohner into a Twin.",
            vec!["funk", "prince", "fender", "funky"],
            0.20,
            0.70,
            0.45,
            0.50,
        ...
        AmpPreset::new(
            "James Brown",
            "Jimmy Nolan's rhythmic assault. Clean, percussive, relentless.",
            vec!["funk", "james-brown", "rhythm", "percussive"],
            0.15,
            0.75,
            0.45,
            0.55,
        ...
        AmpPreset::new(
            "Sly Stone",
            "Sly's funky Fender. Deep pocket, rolling groove, swagger.",
            vec!["funk", "sly-stone", "vintage", "groove"],
            0.20,
            0.70,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Earth Wind & Fire",
            "Al McKay's clean, percussive rhythm. Tight as a drum, bright as the sun.",
            vec!["funk", "ewf", "al-mckay", "rhythm"],
            0.15,
            0.75,
            0.40,
            0.50,
        ...
        AmpPreset::new(
            "Stevie Wonder",
            "Stevie's guitar tones. Lively, rhythmic, always in service of the song.",
            vec!["funk", "stevie-wonder", "rhythm", "groove"],
            0.20,
            0.70,
            0.45,
            0.55,
        ...
        AmpPreset::new(
            "Anderson .Paak",
            "Modern funk-groove. Clean, bouncy, infectious rhythm guitar.",
            vec!["funk", "anderson-paak", "modern", "groove"],
            0.20,
            0.70,
            0.45,
            0.55,
...
fn shoegaze_dream_pop_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Loveless",
            "My Bloody Valentine's wall of sound. Drenched, swirling, glorious noise.",
            vec!["shoegaze", "my-bloody-valentine", "wall-of-sound", "noise"],
            0.55,
            0.60,
            0.60,
            0.40,
        ...
        AmpPreset::new(
            "Slowdive",
            "Washy, ethereal, dreamlike. Soft distortion that floats rather than punches.",
            vec!["shoegaze", "slowdive", "ethereal", "dream-pop"],
            0.45,
            0.60,
            0.55,
            0.55,
        ...
        AmpPreset::new(
            "Cocteau Twins",
            "Robin Guthrie's shimmering walls. Guitars as atmosphere.",
            vec!["shoegaze", "cocteau-twins", "shimmer", "atmospheric"],
            0.35,
            0.65,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Ride",
            "Oxford's finest. Swirling, jangly, just the right amount of grit.",
            vec!["shoegaze", "ride", "oxford", "jangle"],
            0.50,
            0.55,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Swervedriver",
            "Heavier shoegaze. Riff-driven, driving, less dream more machine.",
            vec!["shoegaze", "swervedriver", "heavy", "driving"],
            0.60,
            0.55,
            0.55,
            0.40,
        ...
        AmpPreset::new(
            ...
            "Feedback-soaked pop songs. Reznor-worship with pop hooks.",
            vec!["shoegaze", "jesus-and-mary-chain", "feedback", "noise-pop"],
            0.60,
            0.55,
            0.45,
            0.50,
        ...
        AmpPreset::new(
            "Lush",
            "Ethereal, jangly, gorgeous. The lighter side of shoegaze, all melody.",
            vec!["shoegaze", "lush", "ethereal", "melodic"],
            0.40,
            0.65,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Chapterhouse",
            "Whirlpool-era swirl. Drenched in reverb, swimming in delay.",
            vec!["shoegaze", "chapterhouse", "swirl", "reverb"],
            0.45,
            0.60,
            0.55,
            0.50,
...
fn ambient_experimental_presets() -> Vec<AmpPreset> {
    vec![
        AmpPreset::new(
            "Ambient Clean",
            "Pristine, open clean. Maximum headroom for delay and reverb to work their magic.",
            vec!["ambient", "clean", "pristine", "pedal-platform"],
            0.10,
            0.85,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Frippertronics",
            "Robert Fripp's looping tone. Clear, articulate, extended high-frequency response.",
            vec!["ambient", "fripp", "loop", "experimental"],
            0.20,
            0.80,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "Lanois Pad",
            "Daniel Lanois' ambient edge. Warm, organic, slightly broken. Beautiful.",
            vec!["ambient", "lanois", "warm", "organic"],
            0.35,
            0.70,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "Bill Frisell",
            "Frisell's quirky, effects-laden clean. Surprising, textural, utterly unique.",
            vec!["ambient", "bill-frisell", "experimental", "textural"],
            0.25,
            0.70,
            0.50,
            0.55,
        ...
        AmpPreset::new(
            "David Torn",
            "Splintered, processed, chaotic. A canvas for processing more than a tone.",
            vec!["ambient", "david-torn", "experimental", "processed"],
            0.40,
            0.65,
            0.55,
            0.50,
        ...
        AmpPreset::new(
            "E-Bow Pad",
            "Clean, compressed, mid-pushed. Optimized for e-bow sustain and harmonic swells.",
            vec!["ambient", "e-bow", "sustain", "pad"],
            0.20,
            0.75,
            0.55,
            0.65,
        ...
        AmpPreset::new(
            "Swell Pad",
            "Smooth, violin-like tone. Rolled-off attack for volume pedal swells.",
            vec!["ambient", "swell", "pad", "smooth"],
            0.15,
            0.80,
            0.55,
            0.60,
        ...
        AmpPreset::new(
            "Reverse Ambience",
            "Mid-heavy, compressed tone for reverse delay. Haunting textures.",
            vec!["ambient", "reverse", "delay", "haunting"],
            0.30,
            0.70,
            0.50,
            0.60,
